        ...
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Transform your business with our AI-powered automation platform. 
              Increase efficiency, reduce costs, and scale your operations with cutting-edge technology.
            </p>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center text-gray-400">
                ...
                <span>hello@aip platform.com</span>
              </div>
              <div className="flex items-center text-gray-400">
